...
<?php echo $this->Form->create('Banner'); ?>
	...
	<?php
		...
		echo $this->Form->input('filter_status', array('type' => 'select', 'label' => '', 'options' => array('all' => 'Select Status', 'premium' => 'Premium', 'non-premium' => 'Non-Premium'), 'class' => 'combo2 curve1','div'=>false)); ?>
		&nbsp;
		<?php
